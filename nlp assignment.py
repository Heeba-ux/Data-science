# -*- coding: utf-8 -*-
"""
Created on Sat May 15 15:33:04 2021
...
df = pd.read_csv('C:/Users/DELL/Desktop/360 DIGITMG/NLP/Data.csv', usecols=['text'])
df.head(10)
...
# data directory 
articles = list(load_articles('C:/Users/DELL/Desktop/360 DIGITMG/NLP/Data.csv'))
...
with open("C:/Users/DELL/Desktop/360 DIGITMG/NLP/NLP-TM.txt",encoding="utf8") as file:
    lor = file.read()
